...
<div id="newPost">
    ...
    <form ng-controller="NewPostCtrl">
        <textarea id='postContent' ng-model="postContent"
                  ng-class="{'charsLow' : charsRemaining() < 12,
                            'charsOverflow' : charsRemaining() < 0}">
        </textarea>
        <button type="button" ng-click="newPost()" ng-disabled="postInvalidLength()">Post</button>
...
<div ng-controller="PostCtrl">
    <div class="allPosts" ng-cloak>
        ...
        <div class="postEntry" ng-repeat="post in allPosts" ng-controller="EditPostCtrl"
             ...
             ng-mouseleave="desactivate()">

            <span ng-show="isEditState">
                <textarea class="inplacePostEdit"
                          ng-model="editedContent"></textarea>
            ...
            <span ng-show="!isEditState">
                ...
                <div class="postDate">{{post.published}}
                by {{post.user}}
                </div>
            </span>
        </div>
